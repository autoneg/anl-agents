...
AUTHOR = 'Hosssein Savari'
MEMBERS = [{'name': 'Hosssein Savari', 'institution': 'University of Tehran', 'country': 'Iran'}, {'name': 'Ali Jahani', 'institution': 'University of Tehran', 'country': 'Iran'}]
COUNTRY = 'Iran'
