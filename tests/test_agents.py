...
def test_get_agents_per_year1(version, track):
...
@mark.parametrize(["version", "track"], product(years, tracks))
def test_get_agents_per_year2(version, track):
